...
class ConsoleTest(unittest.TestCase):
    ...
    def test_console(self):
        ...
        self.assert_equal_b64(s, b'Ny42NRtbMG0bWzkwbSB8IBtbMG0bWzBtaGVsbG8gd29ybGQbWzBt\n')

        colors = ['black', 'blue', 'cyan', 'default', 'green', 'grey', 'magenta', 'orange', 'red', 'white', 'yellow', 'darkyellow']
        checks = [
            b'OC45MRtbOTBtG1s5MG0gfCAbWzBtG1s5MG1ibGFjaxtbMG0=\n=\n',
            b'OC44ORtbMzRtG1s5MG0gfCAbWzBtG1szNG1ibHVlG1swbQ==\n==\n',
            b'NC4xNxtbMzZtG1s5MG0gfCAbWzBtG1szNm1jeWFuG1swbQ==\n',
            b'NS4wMxtbMG0bWzkwbSB8IBtbMG0bWzBtZGVmYXVsdBtbMG0=\n',
            b'NS40NxtbMzJtG1s5MG0gfCAbWzBtG1szMm1ncmVlbhtbMG0=\n',
            b'NS44OBtbOTBtG1s5MG0gfCAbWzBtG1s5MG1ncmV5G1swbQ==\n',
            b'Ny41MhtbMzVtG1s5MG0gfCAbWzBtG1szNW1tYWdlbnRhG1swbQ==\n',
            b'Ni4xNxtbOTFtG1s5MG0gfCAbWzBtG1s5MW1vcmFuZ2UbWzBt\n',
            b'Ny40MRtbMzFtG1szMW0gfCAbWzBtG1szMW1yZWQbWzBt\n',
            b'Ny4zMBtbOTdtG1s5MG0gfCAbWzBtG1s5N213aGl0ZRtbMG0=\n',
            b'Ny45MRtbMzNtG1s5MG0gfCAbWzBtG1szM215ZWxsb3cbWzBt\n',

            b'MTEuMjEbWzMzbRtbOTBtIHwgG1swbRtbMzNtZGFya3llbGxvdxtbMG0==\n', ]
    ...
    def test_reversed_keywordparam(self):
        ...
        self.assert_equal_b64(s, b'OC44OBtbMG0bWzkwbSB8IBtbMG0bWzBtaGVsbG8gd29ybGQbWzBt\n')
